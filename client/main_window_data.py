...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        self.label_contacts.setGeometry(QtCore.QRect(10, 0, 151, 16))
        ...
        self.btn_send.setGeometry(QtCore.QRect(540, 450, 161, 31))
        self.btn_send.setObjectName("btn_send")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(350, 450, 151, 31))
